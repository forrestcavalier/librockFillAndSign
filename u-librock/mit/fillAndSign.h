#if !defined(librock_fillAndSign_H)
#define librock_fillAndSign_H 1
...
For the purposes of fillAndSign, librock_preinclude should have
...
#include <string.h>
    ...
    const char *librock_fillAndSign( //Compute an AWS Version 4 or Version 2 signature
...
void librock_fillAndSign_coverage();
