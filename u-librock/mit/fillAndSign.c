/* fillAndSign.c Copyright 2016 MIB SOFTWARE, INC.
 ...
 GET HELP:  Visit http://www.mibsoftware.com/librockFillAndSign/
...
#endif
#define LIBROCK_SRC_FILLANDSIGN 1 //Identify the source module
#include "fillAndSign.h"
...
const char *librock_fillAndSign(
...
{//Callers should use librock_fillAndSign(), not this.
